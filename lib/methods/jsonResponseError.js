...
function jsonResponseError(req, res, err) {
  ...
  statusCode = R.compose(R.defaultTo(HTTP_STATUS_CODE_SERVER_ERROR), R.prop('statusCode'))(err);

  delete err.statusCode;

  response = R.merge(R.apply(R.bind(makeJsonResponseBody, req), [statusCode, req.flash]), { data : err });
